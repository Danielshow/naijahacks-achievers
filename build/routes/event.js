...
router.post('/event', _auth2.default.verifyToken, _multer_config2.default.single('image'), [_event2.default.verifyBody, _event2.default.verifyDate, _event2.default.verifyTime, _event2.default.isFileAvailable, _event2.default.isValidCategory], _event4.default.createEvent);
router.get('/event', _event4.default.getAllEvent);
router.get('/event/:id', _auth2.default.isValidID, _event4.default.getOneEvent);
router.put('/event/:id', _auth2.default.verifyToken, _multer_config2.default.single('image'), [_auth2.default.isValidID, _db2.default.isUserResource, _event2.default.verifyBody, _event2.default.verifyDate, _event2.default.isFileAvailable, _event2.default.verifyTime, _event2.default.isValidCategory], _event4.default.updateEvent);
